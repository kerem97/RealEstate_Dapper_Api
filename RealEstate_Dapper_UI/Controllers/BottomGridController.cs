...
namespace RealEstate_Dapper_UI.Controllers
{
    public class BottomGridController : Controller
    {
        ...
        public async Task<IActionResult> CreateBottomGrid(CreateBottomGridDto createBottomGridDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7245/api/BottomGrids", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7245/api/BottomGrids/{id}");
        ...
        public async Task<IActionResult> UpdateBottomGrid(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:7245/api/BottomGrids/{id}");
        ...
        public async Task<IActionResult> UpdateBottomGrid(UpdateBottomGridDto updateBottomGridDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7245/api/BottomGrids", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
